...
const SvgJamaicaFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      d="M511.47 391.713 304.329 256 511.47 120.287c-3.021-18.162-18.796-32.011-37.815-32.011h-9.984L256 224.337 48.329 88.276h-9.984c-19.019 0-34.795 13.849-37.815 32.011L207.671 256 .53 391.713c3.02 18.162 18.796 32.011 37.815 32.011h9.984L256 287.663l207.671 136.061h9.984c19.019 0 34.794-13.849 37.815-32.011z"
    />
    <path
      style={{
        fill: "#464655",
      }}
      d="M512 119.939v272.122L304.329 256zM0 392.061V119.939L207.671 256z"
    />
  </svg>
);

export default SvgJamaicaFlag;
